...
@section('alpineData')
  x-data="{ page: 'page404', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop':
  false }"
  x-init="
...
@section('body')
  ...
  <div class="relative z-1 flex min-h-screen flex-col items-center justify-center overflow-hidden p-6">
    ...
    @include('layouts.partials.common-grid-shape')
    ...
    <div class="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
      ...
      <img src="{{asset('storage/images/error/404.svg')}}" alt="404" class="dark:hidden" />
      <img src="{{asset('storage/images/error/404.svg')}}" alt="404" class="hidden dark:block" />
