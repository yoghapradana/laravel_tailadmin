@section('title', 'Sign Up| TailAdmin - Tailwind CSS Admin Dashboard Template')
@extends('layouts.theme')
@section('alpineData')
  x-data="{ page: 'comingSoon', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false,
  'scrollTop': false }"
  x-init="
        ...
        <div class="flex items-center justify-center z-1">
          ...
          <div class="flex flex-col items-center max-w-xs">
            <a href="{{ route('dashboard') }}" class="block mb-4">
              <img src="{{asset('storage/images/logo/auth-logo.svg')}}" alt="Logo" />
            </a>
