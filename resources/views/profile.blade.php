@section('title', 'Profile | TailAdmin - Tailwind CSS Admin Dashboard Template')
...
<!-- BEGIN MODAL -->
@section('modal')
  @include('layouts.partials.profile.profile-info-modal')
  @include('layouts.partials.profile.profile-address-modal')
@endsection
<!-- END MODAL -->