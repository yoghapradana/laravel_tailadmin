    ...
    >
      ...
      <a href="index.html" class="lg:hidden">
        ...
        <img
          ...
          src="{{asset('storage/images/logo/logo-dark.svg')}}"
          alt="Logo"
        />
      </a>
            ...
            <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('storage/images/user/user-02.jpg') }}"
                      alt="User"
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('storage/images/user/user-03.jpg') }}"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('storage/images/user/user-04.jpg') }}"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('storage/images/user/user-05.jpg') }}"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
      ...
      >
        ...
        >
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
            <img src="{{asset('storage/images/user/owner.jpg')}}" alt="User" />
          </span>
