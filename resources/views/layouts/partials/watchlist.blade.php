    ...
    <div class="custom-scrollbar flex h-auto flex-col overflow-y-auto pr-3">
      ...
      >
        <div class="flex items-center gap-3">
          <div class="h-10 w-10">
            <img src="{{asset('storage/images/brand/brand-07.svg')}}" alt="brand" />
          </div>
      ...
      >
        <div class="flex items-center gap-3">
          <div class="h-10 w-10">
            <img src="{{asset('storage/images/brand/brand-11.svg')}}" alt="brand" />
          </div>
      ...
      >
        <div class="flex items-center gap-3">
          <div class="h-10 w-10">
            <img src="{{asset('storage/images/brand/brand-12.svg')}}" alt="brand" />
          </div>
      ...
      >
        <div class="flex items-center gap-3">
          <div class="h-10 w-10">
            <img src="{{asset('storage/images/brand/brand-13.svg')}}" alt="brand" />
          </div>
      ...
      >
        <div class="flex items-center gap-3">
          <div class="h-10 w-10">
            <img src="{{asset('storage/images/brand/brand-14.svg')}}" alt="brand" />
          </div>
